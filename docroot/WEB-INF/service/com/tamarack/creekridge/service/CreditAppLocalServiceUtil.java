...
/**
 * Provides the local service utility for CreditApp. This utility wraps
 * {@link com.tamarack.creekridge.service.impl.CreditAppLocalServiceImpl} and is the
 ...
 * @generated
 */
public class CreditAppLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.tamarack.creekridge.service.impl.CreditAppLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.tamarack.creekridge.model.CreditApp addCreditApp(
		...
		return getService().addCreditApp(creditApp);
	}
	...
	*/
	public static com.tamarack.creekridge.model.CreditApp createCreditApp(
		long creditAppId) {
		return getService().createCreditApp(creditAppId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.tamarack.creekridge.model.CreditApp deleteCreditApp(
		long creditAppId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteCreditApp(creditAppId);
	}
	...
	*/
	public static com.tamarack.creekridge.model.CreditApp deleteCreditApp(
		com.tamarack.creekridge.model.CreditApp creditApp)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteCreditApp(creditApp);
	}
	...
	*/
	...
	public static com.tamarack.creekridge.model.CreditApp fetchCreditApp(
		long creditAppId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchCreditApp(creditAppId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.tamarack.creekridge.model.CreditApp getCreditApp(
		long creditAppId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getCreditApp(creditAppId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.tamarack.creekridge.model.CreditApp> getCreditApps(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCreditApps(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getCreditAppsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCreditAppsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.tamarack.creekridge.model.CreditApp updateCreditApp(
		com.tamarack.creekridge.model.CreditApp creditApp)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateCreditApp(creditApp);
	}
	...
	*/
	...
	public static CreditAppLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					CreditAppLocalService.class.getName());

			if (invokableLocalService instanceof CreditAppLocalService) {
				_service = (CreditAppLocalService)invokableLocalService;
			}
			else {
				_service = new CreditAppLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(CreditAppLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(CreditAppLocalService service) {
	}

	private static CreditAppLocalService _service;
}