...
/**
 * Provides the local service interface for CreditAppStatus. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author tamarack
 * @see CreditAppStatusLocalServiceUtil
...
public interface CreditAppStatusLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CreditAppStatusLocalServiceUtil} to access the credit app status local service. Add custom service methods to {@link com.tamarack.creekridge.service.impl.CreditAppStatusLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
