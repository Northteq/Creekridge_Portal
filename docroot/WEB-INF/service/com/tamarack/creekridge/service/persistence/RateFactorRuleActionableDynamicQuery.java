...
public abstract class RateFactorRuleActionableDynamicQuery
	...
	public RateFactorRuleActionableDynamicQuery() throws SystemException {
		setBaseLocalService(RateFactorRuleLocalServiceUtil.getService());
		setClass(RateFactorRule.class);

		setClassLoader(com.tamarack.creekridge.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("rateFactorRuleId");
	}
}