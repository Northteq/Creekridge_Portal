...
public abstract class CreditAppStatusActionableDynamicQuery
	...
	public CreditAppStatusActionableDynamicQuery() throws SystemException {
		setBaseLocalService(CreditAppStatusLocalServiceUtil.getService());
		setClass(CreditAppStatus.class);

		setClassLoader(com.tamarack.creekridge.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("CreditAppStatusId");
	}
}