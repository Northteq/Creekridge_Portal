...
public abstract class CreditAppBankReferenceActionableDynamicQuery
	...
	public CreditAppBankReferenceActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(CreditAppBankReferenceLocalServiceUtil.getService());
		setClass(CreditAppBankReference.class);

		setClassLoader(com.tamarack.creekridge.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("bankReferenceId");
	}
}