...
/**
 * Provides the local service utility for CreditAppBankReference. This utility wraps
 * {@link com.tamarack.creekridge.service.impl.CreditAppBankReferenceLocalServiceImpl} and is the
 ...
 * @generated
 */
public class CreditAppBankReferenceLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.tamarack.creekridge.service.impl.CreditAppBankReferenceLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.tamarack.creekridge.model.CreditAppBankReference addCreditAppBankReference(
		...
		return getService().addCreditAppBankReference(creditAppBankReference);
	}
	...
	*/
	public static com.tamarack.creekridge.model.CreditAppBankReference createCreditAppBankReference(
		long bankReferenceId) {
		return getService().createCreditAppBankReference(bankReferenceId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.tamarack.creekridge.model.CreditAppBankReference deleteCreditAppBankReference(
		long bankReferenceId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteCreditAppBankReference(bankReferenceId);
	}
	...
	*/
	public static com.tamarack.creekridge.model.CreditAppBankReference deleteCreditAppBankReference(
		com.tamarack.creekridge.model.CreditAppBankReference creditAppBankReference)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteCreditAppBankReference(creditAppBankReference);
	}
	...
	*/
	...
	public static com.tamarack.creekridge.model.CreditAppBankReference fetchCreditAppBankReference(
		long bankReferenceId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchCreditAppBankReference(bankReferenceId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.tamarack.creekridge.model.CreditAppBankReference getCreditAppBankReference(
		long bankReferenceId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getCreditAppBankReference(bankReferenceId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.tamarack.creekridge.model.CreditAppBankReference> getCreditAppBankReferences(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCreditAppBankReferences(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getCreditAppBankReferencesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCreditAppBankReferencesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.tamarack.creekridge.model.CreditAppBankReference updateCreditAppBankReference(
		com.tamarack.creekridge.model.CreditAppBankReference creditAppBankReference)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateCreditAppBankReference(creditAppBankReference);
	}
	...
	*/
	...
	public static java.util.List<com.tamarack.creekridge.model.CreditAppBankReference> getCreditAppBankReferenceByCreditApp(
	...
	*/
	...
	public static CreditAppBankReferenceLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					CreditAppBankReferenceLocalService.class.getName());

			if (invokableLocalService instanceof CreditAppBankReferenceLocalService) {
				_service = (CreditAppBankReferenceLocalService)invokableLocalService;
			}
			else {
				_service = new CreditAppBankReferenceLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(CreditAppBankReferenceLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(CreditAppBankReferenceLocalService service) {
	}

	private static CreditAppBankReferenceLocalService _service;
}