...
public class CreditAppDocumentModelImpl extends BaseModelImpl<CreditAppDocument>
	...
	public static long DOCUMENTFILENAME_COLUMN_BITMASK = 2L;
	...
	public void setDocumentFileName(String documentFileName) {
		_columnBitmask |= DOCUMENTFILENAME_COLUMN_BITMASK;

		if (_originalDocumentFileName == null) {
			_originalDocumentFileName = _documentFileName;
		}

		_documentFileName = documentFileName;
	}

	public String getOriginalDocumentFileName() {
		return GetterUtil.getString(_originalDocumentFileName);
	}

	@Override
	public Blob getDocumentFileContent() {
		if (_documentFileContentBlobModel == null) {
			try {
				_documentFileContentBlobModel = CreditAppDocumentLocalServiceUtil.getDocumentFileContentBlobModel(getPrimaryKey());
			}
			catch (Exception e) {
			}
		}
		...
		if (_documentFileContentBlobModel != null) {
			blob = _documentFileContentBlobModel.getDocumentFileContentBlob();
		}
	...
	public void setDocumentFileContent(Blob documentFileContent) {
		if (_documentFileContentBlobModel == null) {
			_documentFileContentBlobModel = new CreditAppDocumentDocumentFileContentBlobModel(getPrimaryKey(),
					documentFileContent);
		}
		else {
			_documentFileContentBlobModel.setDocumentFileContentBlob(documentFileContent);
		}
	}
	...
	public void resetOriginalValues() {
		...
		creditAppDocumentModelImpl._originalDocumentFileName = creditAppDocumentModelImpl._documentFileName;

		creditAppDocumentModelImpl._documentFileContentBlobModel = null;
	...
	private String _originalDocumentFileName;
	private CreditAppDocumentDocumentFileContentBlobModel _documentFileContentBlobModel;
