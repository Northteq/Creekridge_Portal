...
/**
 * Provides the base implementation for the credit app local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.tamarack.creekridge.service.impl.CreditAppLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CreditAppLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CreditAppLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.tamarack.creekridge.service.CreditAppLocalServiceUtil} to access the credit app local service.
	 */
	...
	@Override
	public CreditApp addCreditApp(CreditApp creditApp)
		throws SystemException {
		creditApp.setNew(true);

		return creditAppPersistence.update(creditApp);
	}
	 ...
	 */
	@Override
	public CreditApp createCreditApp(long creditAppId) {
		return creditAppPersistence.create(creditAppId);
	}
	...
	@Override
	public CreditApp deleteCreditApp(long creditAppId)
		throws PortalException, SystemException {
		return creditAppPersistence.remove(creditAppId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CreditApp deleteCreditApp(CreditApp creditApp)
		throws SystemException {
		return creditAppPersistence.remove(creditApp);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CreditApp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return creditAppPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return creditAppPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return creditAppPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CreditApp fetchCreditApp(long creditAppId) throws SystemException {
		return creditAppPersistence.fetchByPrimaryKey(creditAppId);
	}
	 ...
	 */
	@Override
	public CreditApp getCreditApp(long creditAppId)
		throws PortalException, SystemException {
		return creditAppPersistence.findByPrimaryKey(creditAppId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return creditAppPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CreditApp> getCreditApps(int start, int end)
		throws SystemException {
		return creditAppPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCreditAppsCount() throws SystemException {
		return creditAppPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CreditApp updateCreditApp(CreditApp creditApp)
		throws SystemException {
		return creditAppPersistence.update(creditApp);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.tamarack.creekridge.model.CreditApp",
			creditAppLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = creditAppPersistence.getDataSource();
	...
	private CreditAppLocalServiceClpInvoker _clpInvoker = new CreditAppLocalServiceClpInvoker();
}