 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.tamarack.creekridge.service.impl.VendorLocalServiceImpl}.
 * </p>
 *
 * @author Tamarack Consulting
 * @see com.tamarack.creekridge.service.impl.VendorLocalServiceImpl
 * @see com.tamarack.creekridge.service.VendorLocalServiceUtil
 * @generated
 */
public abstract class VendorLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VendorLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.tamarack.creekridge.service.VendorLocalServiceUtil} to access the vendor local service.
	 */
	...
	@Override
	public Vendor addVendor(Vendor vendor) throws SystemException {
		vendor.setNew(true);
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Vendor deleteVendor(Vendor vendor) throws SystemException {
	...
	@Override
	public Vendor fetchVendor(long vendorId) throws SystemException {
	 ...
	 */
	@Override
	public int getVendorsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Vendor updateVendor(Vendor vendor) throws SystemException {
		return vendorPersistence.update(vendor);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.tamarack.creekridge.model.Vendor",
			vendorLocalService);
	}
	...
	private VendorLocalServiceClpInvoker _clpInvoker = new VendorLocalServiceClpInvoker();
}