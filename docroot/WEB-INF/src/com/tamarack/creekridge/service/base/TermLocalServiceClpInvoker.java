...
public class TermLocalServiceClpInvoker {
	public TermLocalServiceClpInvoker() {
		...
		_methodParameterTypes0 = new String[] {
				"com.tamarack.creekridge.model.Term"
			};
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return TermLocalServiceUtil.addTerm((com.tamarack.creekridge.model.Term)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return TermLocalServiceUtil.deleteTerm((com.tamarack.creekridge.model.Term)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return TermLocalServiceUtil.updateTerm((com.tamarack.creekridge.model.Term)arguments[0]);
		}
